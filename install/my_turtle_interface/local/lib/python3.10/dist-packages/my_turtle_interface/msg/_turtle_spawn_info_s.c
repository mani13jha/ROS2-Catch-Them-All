...
bool my_turtle_interface__msg__turtle_spawn_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_turtle_interface.msg._turtle_spawn_info.TurtleSpawnInfo", full_classname_dest, 58) == 0);
  }
  my_turtle_interface__msg__TurtleSpawnInfo * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of TurtleSpawnInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_turtle_interface.msg._turtle_spawn_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurtleSpawnInfo");
