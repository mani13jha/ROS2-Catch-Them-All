...
my_turtle_interface__msg__TurtleSpawnInfo__init(my_turtle_interface__msg__TurtleSpawnInfo * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    my_turtle_interface__msg__TurtleSpawnInfo__fini(msg);
    return false;
  }
  return true;
}
...
my_turtle_interface__msg__TurtleSpawnInfo__create()
{
  ...
  my_turtle_interface__msg__TurtleSpawnInfo * msg = (my_turtle_interface__msg__TurtleSpawnInfo *)allocator.allocate(sizeof(my_turtle_interface__msg__TurtleSpawnInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_turtle_interface__msg__TurtleSpawnInfo));
  bool success = my_turtle_interface__msg__TurtleSpawnInfo__init(msg);
  if (!success) {
...
my_turtle_interface__msg__TurtleSpawnInfo__Sequence__init(my_turtle_interface__msg__TurtleSpawnInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_turtle_interface__msg__TurtleSpawnInfo * data = NULL;

  if (size) {
    data = (my_turtle_interface__msg__TurtleSpawnInfo *)allocator.zero_allocate(size, sizeof(my_turtle_interface__msg__TurtleSpawnInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_turtle_interface__msg__TurtleSpawnInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_turtle_interface__msg__TurtleSpawnInfo__fini(&data[i - 1]);
      }
...
my_turtle_interface__msg__TurtleSpawnInfo__Sequence__fini(my_turtle_interface__msg__TurtleSpawnInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_turtle_interface__msg__TurtleSpawnInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_turtle_interface__msg__TurtleSpawnInfo__Sequence * array = (my_turtle_interface__msg__TurtleSpawnInfo__Sequence *)allocator.allocate(sizeof(my_turtle_interface__msg__TurtleSpawnInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_turtle_interface__msg__TurtleSpawnInfo__Sequence__init(array, size);
  if (!success) {
...
my_turtle_interface__msg__TurtleSpawnInfo__Sequence__destroy(my_turtle_interface__msg__TurtleSpawnInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_turtle_interface__msg__TurtleSpawnInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_turtle_interface__msg__TurtleSpawnInfo__Sequence__are_equal(const my_turtle_interface__msg__TurtleSpawnInfo__Sequence * lhs, const my_turtle_interface__msg__TurtleSpawnInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_turtle_interface__msg__TurtleSpawnInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_turtle_interface__msg__TurtleSpawnInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_turtle_interface__msg__TurtleSpawnInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_turtle_interface__msg__TurtleSpawnInfo * data =
      (my_turtle_interface__msg__TurtleSpawnInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_turtle_interface__msg__TurtleSpawnInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_turtle_interface__msg__TurtleSpawnInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_turtle_interface__msg__TurtleSpawnInfo__copy(
